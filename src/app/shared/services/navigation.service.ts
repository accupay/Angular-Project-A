...
export class NavigationService {
  ...
  defaultMenu: IMenuItem[] = [
    ...
    //       state: "reports/transaction-report",
    //       type: "link",
    //     },
    //     {
    //       icon: "i-Over-Time",
    //       name: "Refund Payment Transaction Report",
    //       state: "reports/refund-payment-transaction-report",
    //       type: "link",
    //     },
    //     {
    //       icon: "i-Clock",
    //       name: "Retailer Payment Transaction Report",
    //       state: "reports/retailer-payment-transaction-report",
    //       type: "link",
    //     },
    //   ],
    // },
